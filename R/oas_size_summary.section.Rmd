...
- No significant difference is observed between version 2 (`r format(round(df$avg_size[1],1), big.mark = ",")`Kb) and 3 (`r format(round(df$avg_size_openapi[1],1), big.mark = ",")`Kb)
