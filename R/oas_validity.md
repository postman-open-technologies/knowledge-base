...
- Out of 15,562 entries, 12,018 (77.2%) are valid and 3,544 (22.8%) are
  invalid
- 4,587 out of the 5,876 Swagger (v2.x) entries are valid (78.1%)
- 7,431 out of the 9,686 OpenAPI (v3.x) entries are valid (76.7%)
