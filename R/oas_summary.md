...
- Out of 4,630 valid OpenAPI version 2.x specifications, 3,416 (73.8%)
  have a `host` property, 3,395 (73.3%) have a `basePath` property, and
  3,740 (80.8%) have a `schemes` property.

- Out of 7,487 valid OpenAPI version 3.x specifications, 6,047 (80.8%)
...
- For OpenAPI (v3.x), out of the 7,487 valid APIs, 3,231 (43.2%) have a
