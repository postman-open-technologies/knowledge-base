...
*DISCLAIMER: the results and findings below are preliminary and have not been fully validated or peer reviewed. Use with care. Do not quote or disseminate.*
...
- `r format_count(df$n_openapi[1])` out of the `r format_count(df$n_valid_openapi[1])` OpenAPI (v3.x) entries are valid (`r format_pct(df$pct_valid_openapi[1])`%)
